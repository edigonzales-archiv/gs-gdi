...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{e3f49d24-003e-4244-bf55-ac05cfd15720}">
      <rule filter="ipm10_2020 > 0 AND ipm10_2020 &lt;= 1.9999" key="{bdd12dd9-dd8f-4b96-8051-8c927eabeb50}" symbol="0" label="&lt; 2"/>
      <rule filter="ipm10_2020 > 2 AND ipm10_2020 &lt;= 3.9999" key="{7bc6c31f-091d-4848-bf1c-d8b7cd109b82}" symbol="1" label="2 -4"/>
      <rule filter="ipm10_2020 > 4 AND ipm10_2020 &lt;= 5.9999" key="{4ab56954-5ad3-4e7c-9bd3-cdad91710b8f}" symbol="2" label="4 - 6"/>
      <rule filter="ipm10_2020 > 6 AND ipm10_2020 &lt;= 7.9999" key="{b8ca8138-2e28-4f36-b6d6-57aa576d5735}" symbol="3" label="6 - 8"/>
      <rule filter="ipm10_2020 > 8 AND ipm10_2020 &lt;= 9.9999" key="{df01e73e-3464-4ed7-aaa4-7a944141829c}" symbol="4" label="8 - 10"/>
      <rule filter="ipm10_2020 > 10 AND ipm10_2020 &lt;= 11.9999" key="{d4f8c124-12f9-4df9-b438-653abd69d8d8}" symbol="5" label="10 - 12"/>
      <rule filter="ipm10_2020 > 12 AND ipm10_2020 &lt;= 13.9999" key="{5c19a59a-4032-4ad1-8e38-386517a8eb18}" symbol="6" label="12 - 14"/>
      <rule filter="ipm10_2020 > 14 AND ipm10_2020 &lt;= 15.9999" key="{3a027c02-98cb-4560-9f18-15150f235f54}" symbol="7" label="14 - 16"/>
      <rule filter="ipm10_2020 > 16 AND ipm10_2020 &lt;= 17.9999" key="{db3f4f5f-299d-4098-9e69-3e27778500c2}" symbol="8" label="16 - 18"/>
      <rule filter="ipm10_2020 > 18 AND ipm10_2020 &lt;= 19.9999" key="{210bcfaf-b360-48b2-881b-40ec7b6e2338}" symbol="9" label="18 - 20"/>
      <rule filter="ipm10_2020 > 20 AND ipm10_2020 &lt;= 21.9999" key="{c76c4231-8781-41be-9690-616a1f17bd1d}" symbol="10" label="20 - 22"/>
      <rule filter="ipm10_2020 > 22 AND ipm10_2020 &lt;= 23.9999" key="{b7f676b8-c329-4932-8555-b0d92b35c7b6}" symbol="11" label="22 - 24"/>
      <rule filter="ipm10_2020 > 24 AND ipm10_2020 &lt;= 25.9999" key="{9f0bf3f4-cab5-42b7-b286-8d25f1eae5ff}" symbol="12" label="24 - 26"/>
      <rule filter="ipm10_2020 > 26 AND ipm10_2020 &lt;= 27.9999" key="{5f2bb436-3415-41c8-8a51-1076eb5d31ae}" symbol="13" label="26 - 28"/>
      <rule filter="ipm10_2020 > 28 AND ipm10_2020 &lt;= 29.9999" key="{01aea006-16a8-4c17-a00e-5e2c32128766}" symbol="14" label="28 - 30"/>
      <rule filter="ipm10_2020 > 30 AND ipm10_2020 &lt;= 31.9999" key="{b847b75b-830c-4abb-9649-51921a11cf1a}" symbol="15" label="30 - 32"/>
      <rule filter="ipm10_2020 > 32 AND ipm10_2020 &lt;= 33.9999" key="{b5f77c6d-e588-4f72-9242-14eaeba95b7c}" symbol="16" label="32 - 34"/>
      <rule filter="ipm10_2020 > 34 AND ipm10_2020 &lt;= 35.9999" key="{6ab998fd-81f7-4f8c-8b24-2a0b6f407cb8}" symbol="17" label="34 - 36"/>
      <rule filter="ipm10_2020 > 36 AND ipm10_2020 &lt;= 37.9999" key="{bc9c3dec-816e-4a09-a469-ffa8b4fa38b8}" symbol="18" label="36 - 38"/>
      <rule filter="ipm10_2020 > 38 AND ipm10_2020 &lt;= 39.9999" key="{12fc5cdf-11dc-408d-b87f-6dad2da0bbe8}" symbol="19" label="> 38"/>
    </rules>
    <symbols>
