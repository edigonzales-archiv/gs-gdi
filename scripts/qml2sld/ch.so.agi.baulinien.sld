...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>ch.so.agi.baulinien</se:Name>
    <UserStyle>
      <se:Name>ch.so.agi.baulinien</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Baulinie</se:Name>
          <se:Description>
            <se:Title>Baulinie</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>art</ogc:PropertyName>
              <ogc:Literal>Baulinie</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              ...
              <se:SvgParameter name="stroke-dasharray">11 7 4 7</se:SvgParameter>
            </se:Stroke>
          </se:LineSymbolizer>
        </se:Rule>
        <se:Rule>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>art</ogc:PropertyName>
              <ogc:Literal>Gestaltungsbaulinie</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:MinScaleDenominator>0</se:MinScaleDenominator>
          <se:MaxScaleDenominator>6000</se:MaxScaleDenominator>
        ...
        <se:Rule>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>art</ogc:PropertyName>
              <ogc:Literal>Waldabstandslinie</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:MinScaleDenominator>0</se:MinScaleDenominator>
          <se:MaxScaleDenominator>6000</se:MaxScaleDenominator>
        ...
        <se:Rule>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>art</ogc:PropertyName>
              <ogc:Literal>weitere.Vorbaulinie</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:MinScaleDenominator>0</se:MinScaleDenominator>
          <se:MaxScaleDenominator>6000</se:MaxScaleDenominator>
