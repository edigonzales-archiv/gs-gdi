...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>ch.so.arp.nutzungsplanung.erschliessungsplanung.verkehrsflaechen</se:Name>
    <UserStyle>
      <se:Name>ch.so.arp.nutzungsplanung.erschliessungsplanung.verkehrsflaechen</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
              ...
              <se:GraphicFill>
                <se:Graphic>
                  <se:Mark>
                    ...
                    <se:Stroke>
                      <se:SvgParameter name="stroke">#48006c</se:SvgParameter>
        ...
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#6626d9</se:SvgParameter>
            </se:Fill>
          </se:PolygonSymbolizer>
        </se:Rule>
        <se:Rule>
        ...
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#73ffcc</se:SvgParameter>
            </se:Fill>
          </se:PolygonSymbolizer>
        </se:Rule>
        <se:Rule>
