<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="1" minimumScale="0" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.19">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{17ff0186-e5fc-4861-ba6b-14b8490728f4}">
      <rule key="{105175ab-c265-4b42-9805-c48936d8c1bf}" label="Landschaft" scalemaxdenom="100000" scalemindenom="1" symbol="0">
        <rule filter="&quot;o_art&quot; = 'L2'" key="{6b4270e2-b516-4ae7-8f07-21324ca0c7f5}" label="Güterregulierung Vorhaben" symbol="1" />
        <rule filter="&quot;o_art&quot; = 'L12'" key="{bd2bff68-7dc8-4729-bda3-70c69a28b662}" label="Anlage für Freizeit und Sport Vorhaben" symbol="2" />
        <rule filter="&quot;o_art&quot; = 'L1'" key="{cfdb2af1-3e9d-46b4-b0ea-a04b6379aeb3}" label="Anlage für Freizeit und Sport bestehend" symbol="3" />
      </rule>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" type="marker">
        ...
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/3f663b93f089d1d89df27ae9f18f629a.svg" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="0,0,0,255" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="2" type="marker">
        ...
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="color" v="227,26,28,255" />
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/4a3220be32a3ab3e3e0956de45f4430a.svg" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="0,0,0,255" />
