...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>ch.so.arp.nutzungsplanung.kantonale_nutzungsplanung_flaeche</se:Name>
    <UserStyle>
      <se:Name>ch.so.arp.nutzungsplanung.kantonale_nutzungsplanung_flaeche</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>kantonale Landwirtschafts und Schutzzone Witi</se:Name>
          <se:Description>
            <se:Title>kantonale Landwirtschafts und Schutzzone Witi</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>typ_kt</ogc:PropertyName>
              <ogc:Literal>N526_kantonale_Landwirtschafts_und_Schutzzone_Witi</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:LineSymbolizer>
            <se:Stroke>
              <se:GraphicStroke>
                <se:Graphic>
                  <se:Mark>
                    ...
                    <se:Fill>
                      <se:SvgParameter name="fill">#71514c</se:SvgParameter>
                    </se:Fill>
                    <se:Stroke>
        ...
        <se:Rule>
          <se:Name>BLN Gebiet</se:Name>
          <se:Description>
            <se:Title>BLN Gebiet</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>typ_kt</ogc:PropertyName>
              <ogc:Literal>N520_BLN_Gebiet</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#844200</se:SvgParameter>
              <se:SvgParameter name="stroke-width">4</se:SvgParameter>
              <se:SvgParameter name="stroke-linejoin">mitre</se:SvgParameter>
              <se:SvgParameter name="stroke-linecap">butt</se:SvgParameter>
              <se:SvgParameter name="stroke-dasharray">18 11</se:SvgParameter>
            </se:Stroke>
        ...
        <se:Rule>
          <se:Name>kantonales Vorranggebiet Natur und Landschaft</se:Name>
          <se:Description>
            <se:Title>kantonales Vorranggebiet Natur und Landschaft</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>typ_kt</ogc:PropertyName>
              <ogc:Literal>N690_kantonales_Vorranggebiet_Natur_und_Landschaft</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
        ...
        <se:Rule>
          <se:Name>Naturreservat inkl. Geotope</se:Name>
          <se:Description>
            <se:Title>Naturreservat inkl. Geotope</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>typ_kt</ogc:PropertyName>
              <ogc:Literal>N522_Naturreservat_inkl_Geotope</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:LineSymbolizer>
            <se:Stroke>
        ...
        <se:Rule>
          <se:Name>Siedlungstrennguertel von kantonaler Bedeutung</se:Name>
          <se:Description>
            <se:Title>Siedlungstrennguertel von kantonaler Bedeutung</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>typ_kt</ogc:PropertyName>
              <ogc:Literal>N525_Siedlungstrennguertel_von_kantonaler_Bedeutung</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
