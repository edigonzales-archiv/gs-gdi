...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>ch.so.agi.av_gb_flaechendifferenzen</se:Name>
    <UserStyle>
      <se:Name>ch.so.agi.av_gb_flaechendifferenzen</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Flächendifferenz Liegenschaft</se:Name>
          <se:Description>
            <se:Title>Flächendifferenz Liegenschaft</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>Flächendifferenz Liegenschaft; in Mutation</se:Name>
          <se:Description>
            <se:Title>Flächendifferenz Liegenschaft; in Mutation</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:Not>
