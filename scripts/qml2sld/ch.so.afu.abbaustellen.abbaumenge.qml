...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="schnitt">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{056dbc5d-320e-49f4-9095-380977a9a743}">
      <rule filter=" &quot;schnitt&quot; &lt; 5" key="{5aeafbe5-3ec1-43eb-bbf7-3d22d018cee9}" symbol="0" label="&lt;5"/>
      <rule filter=" &quot;schnitt&quot; >= 5 AND  &quot;schnitt&quot; &lt;= 50" key="{c5553a3a-2642-48a5-a410-74a6eacc3e0f}" symbol="1" label="5-50"/>
      <rule filter=" &quot;schnitt&quot; > 50 AND  &quot;schnitt&quot; &lt;= 100" key="{da88259c-8624-4959-bc76-68647593ad41}" symbol="2" label="50-100"/>
      <rule filter=" &quot;schnitt&quot; > 100" key="{5c3b8b19-f6c1-4fbb-aaec-abfb3d498a92}" symbol="3" label=">100"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="schnitt" index="1" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="-185773344">
    <columns>
      <column width="-1" hidden="0" type="field" name="t_id"/>
      <column width="-1" hidden="0" type="field" name="schnitt"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="schnitt" expression=""/>
  </defaults>
