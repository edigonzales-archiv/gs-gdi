...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{5dfa8a90-6d3c-4c2a-8240-6d7483795baa}">
      <rule scalemaxdenom="7500" filter=" &quot;elev&quot; %100 != 0" key="{a04a49ad-4c70-46f1-be29-48327365951a}" symbol="0" scalemindenom="1"/>
      <rule scalemaxdenom="7500" filter=" &quot;elev&quot; %100 = 0" key="{c26a7d20-a1b3-440a-92ef-9fba68fc44ad}" symbol="1" scalemindenom="1"/>
      <rule scalemaxdenom="1000000" filter=" &quot;elev&quot; % 50 = 0 AND  &quot;elev&quot; %500 != 0" key="{ea7dcef0-7e22-4b30-9a2a-d8adc3ff410e}" symbol="2" scalemindenom="7500"/>
      <rule scalemaxdenom="1000000" filter=" &quot;elev&quot; % 500 = 0" key="{71262a92-6394-4515-b394-a4c5db8a6ecd}" symbol="3" scalemindenom="7500"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="140,69,0,255"/>
          <prop k="line_style" v="solid"/>
  ...
  <labeling type="rule-based">
    <rules key="{5f95bfcb-4a3d-41ba-bf53-a56817905fb2}">
      <rule scalemaxdenom="7500" description="test" filter=" &quot;elev&quot; % 100 = 0" key="{e232dd0f-3337-4d77-93a9-77edb17b40d3}" scalemindenom="1">
        <settings>
          <text-style fontItalic="1" fontFamily="Frutiger LT Com 55 Roman" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="140,69,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="14" fieldName="elev" namedStyle="56 Italic" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          ...
          <text-buffer bufferSize="0.5" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="1" bufferBlendMode="0" bufferTransp="35" bufferSizeInMapUnits="1" bufferNoFill="0" bufferJoinStyle="128"/>
          ...
          <data-defined>
            <Size expr="14*sqrt(1000/ @map_scale)" field="" active="true" useExpr="true"/>
          </data-defined>
        </settings>
      </rule>
    </rules>
  ...
  <customproperties>
    ...
    <property key="labeling/textColorB" value="79"/>
    <property key="labeling/textColorG" value="79"/>
    <property key="labeling/textColorR" value="79"/>
