...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>ch.so.afu.ekat2010_ch4_land_forstwirtschaft</se:Name>
    <UserStyle>
      <se:Name>ch.so.afu.ekat2010_ch4_land_forstwirtschaft</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>emiss_ch4</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>200 - 1000</se:Name>
          <se:Description>
            <se:Title>200 - 1000</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>1'000 - 2'000</se:Name>
          <se:Description>
            <se:Title>1'000 - 2'000</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>2'000 - 5'000</se:Name>
          <se:Description>
            <se:Title>2'000 - 5'000</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>5'000 - 100'000</se:Name>
          <se:Description>
            <se:Title>5'000 - 100'000</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsGreaterThan>
              <ogc:PropertyName>emiss_ch4</ogc:PropertyName>
