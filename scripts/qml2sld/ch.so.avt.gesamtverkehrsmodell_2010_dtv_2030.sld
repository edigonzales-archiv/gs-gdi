...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>ch.so.avt.gesamtverkehrsmodell_2010_dtv_2030</se:Name>
    <UserStyle>
      <se:Name>ch.so.avt.gesamtverkehrsmodell_2010_dtv_2030</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>1 - 2'000</se:Name>
          <se:Description>
            <se:Title>1 - 2'000</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
                <ogc:PropertyName>dtv2030</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>2'001 - 4'000</se:Name>
          <se:Description>
            <se:Title>2'001 - 4'000</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>4'001 - 6'000</se:Name>
          <se:Description>
            <se:Title>4'001 - 6'000</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>6'001 - 10'000</se:Name>
          <se:Description>
            <se:Title>6'001 - 10'000</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
