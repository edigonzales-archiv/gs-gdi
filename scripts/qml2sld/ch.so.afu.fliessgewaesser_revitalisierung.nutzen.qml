...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="nutzen">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{135113c5-9414-4c03-82dc-905a85e185b8}">
      <rule filter=" &quot;nutzen&quot;  =  'gering' " key="{09f4a6d8-913b-4b77-b965-79f01251de68}" symbol="0" label="gering"/>
      <rule filter=" &quot;nutzen&quot;  =  'gross' " key="{d7d86d35-e39d-4bcd-9510-bf4137e53738}" symbol="1" label="gross"/>
      <rule filter=" &quot;nutzen&quot;  =  'mittel' " key="{38affb51-a881-4ba7-9706-760010515308}" symbol="2" label="mittel"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="0,204,102,255"/>
  ...
  <aliases>
    ...
    <alias field="shape_length" index="2" name=""/>
    <alias field="nutzen" index="3" name=""/>
    <alias field="bemerkung" index="4" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="nutzen"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="nutzen" expression=""/>
