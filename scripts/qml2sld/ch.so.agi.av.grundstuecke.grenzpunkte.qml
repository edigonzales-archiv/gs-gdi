<qgis hasScaleBasedVisibilityFlag="1" maxLabelScale="1e+08" maximumScale="3000" minLabelScale="1" minimumScale="0" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.15">
  <edittypes>
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{a11a3863-f88d-4b63-b73f-7e12351a5422}">
      <rule filter="punktzeichen_txt = 'Stein'" key="{68fb69e6-2286-4701-953d-bede058d94a4}" label="Stein">
        <rule key="{90b077c5-30dc-40fe-ab64-368083df7a8f}" label="1:250" scalemaxdenom="300">
      ...
      <rule filter="punktzeichen_txt = 'Kunststoffzeichen' " key="{ef21a8fa-53ce-422e-a0f0-2bff29647b02}" label="Kunststoffzeichen">
        <rule key="{84a8c26b-19e3-4ab3-96a4-371e9b035369}" label="1:250" scalemaxdenom="300">
      ...
      <rule filter="punktzeichen_txt = 'Bolzen'" key="{434c2560-e011-4481-a1b4-3ee333939a54}" label="Bolzen">
        <rule key="{04320e84-b827-4a2f-9a21-03f7604c554e}" label="1:250" scalemaxdenom="300">
      ...
      <rule filter="punktzeichen_txt = 'Rohr'" key="{ca141fca-4ea9-4999-bb35-79b960768f19}" label="Rohr">
        <rule key="{d00cac68-353c-4c28-9a3b-122ddaae5cc3}" label="1:250" scalemaxdenom="300">
      ...
      <rule filter="punktzeichen_txt = 'Pfahl' " key="{bdf36b74-cca9-4d7e-8c57-85d536d534e7}" label="Pfahl">
        <rule key="{b05b8712-fc12-45c2-943e-02b173da2083}" label="1:250" scalemaxdenom="300">
      ...
      <rule filter="punktzeichen_txt = 'Kreuz'" key="{97c7d47c-ecd6-4d66-be15-7ba09661c447}" label="Kreuz">
        <rule key="{b6b03f68-651e-43de-80d3-03b571a20f59}" label="1:250" scalemaxdenom="300">
      ...
      <rule filter="punktzeichen_txt = 'unversichert'" key="{45f17e07-4f05-42c0-ab79-0b0e19e94ebf}" label="unversichert">
        <rule key="{1d13d54c-e1a7-4dfb-bb10-52577ba64841}" label="1:250" scalemaxdenom="300">
    ...
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" name="25" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="color" v="255,0,0,255" />
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/c553e423f1d6c4c2fefdcb0bf6bd1553.svg" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="0,0,0,255" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="41" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="color" v="255,0,0,255" />
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/a804cdf8bc644d7f9eb8a24bf0e5fef6.svg" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="0,0,0,255" />
  ...
  <aliases>
    ...
    <alias field="lagegenauigkeit" index="2" name="" />
    <alias field="lagezuverlaessigkeit" index="3" name="" />
    <alias field="punktzeichen" index="4" name="" />
    <alias field="punktzeichen_txt" index="5" name="" />
    <alias field="symbolorientierung" index="6" name="" />
    <alias field="bfs_nr" index="7" name="" />
    <alias field="importdatum" index="8" name="" />
    <alias field="nachfuehrung" index="9" name="" />
    <alias field="gueltigkeit" index="10" name="" />
  </aliases>
