...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{c0cea294-caec-452b-ae32-064d36f83de5}">
      <rule filter="ino2_2020 > 0 AND ino2_2020 &lt;= 2.999" key="{cf908728-4287-4720-a378-e948bc664b83}" symbol="0" label="&lt; 3"/>
      <rule filter="ino2_2020 > 3 AND ino2_2020 &lt;= 5.999" key="{4ca91c1f-95d7-4bc9-905c-41bde0f56172}" symbol="1" label="3 - 6"/>
      <rule filter="ino2_2020 > 6 AND ino2_2020 &lt;= 8.999" key="{ae6d3cec-8b99-4871-9b09-f1e598cb566b}" symbol="2" label="6 - 9"/>
      <rule filter="ino2_2020 > 9 AND ino2_2020 &lt;= 11.999" key="{9bded127-27e4-4c32-9ed5-c249e835e375}" symbol="3" label="9 - 12"/>
      <rule filter="ino2_2020 > 12 AND ino2_2020 &lt;= 14.999" key="{41a6d036-b787-4e40-a7db-46ee94f593ac}" symbol="4" label="12 - 15"/>
      <rule filter="ino2_2020 > 15 AND ino2_2020 &lt;= 17.999" key="{e03874d8-6920-4f08-b02c-93a4da3256ed}" symbol="5" label="15 - 18"/>
      <rule filter="ino2_2020 > 18 AND ino2_2020 &lt;= 20.999" key="{32cc83b7-b76b-4456-9a76-2dd7cea7f6c0}" symbol="6" label="18 - 21"/>
      <rule filter="ino2_2020 > 21 AND ino2_2020 &lt;= 23.999" key="{d0a37ef0-d222-4ab2-ad29-fe5f9043247d}" symbol="7" label="21 - 24"/>
      <rule filter="ino2_2020 > 24 AND ino2_2020 &lt;= 26.999" key="{7111c163-e01b-49af-a1a5-0f9bf04405d9}" symbol="8" label="24 - 27"/>
      <rule filter="ino2_2020 > 27 AND ino2_2020 &lt;= 29.999" key="{9701a2c0-7bfe-4a8f-a150-88723722ae32}" symbol="9" label="27 - 30"/>
      <rule filter="ino2_2020 > 30 AND ino2_2020 &lt;= 32.999" key="{0fd0876f-34fb-4e10-8a9f-47b0dca3a440}" symbol="10" label="30 - 33"/>
      <rule filter="ino2_2020 > 33 AND ino2_2020 &lt;= 35.999" key="{e0ba484d-cf0b-4365-a23a-9ddc455eeeab}" symbol="11" label="33 - 36"/>
      <rule filter="ino2_2020 > 36 AND ino2_2020 &lt;= 38.999" key="{1a3969ff-5c2f-431e-92e3-03a8720a8ce8}" symbol="12" label="36 - 39"/>
      <rule filter="ino2_2020 > 39 AND ino2_2020 &lt;= 41.999" key="{a9a2473f-7e1b-4764-96c8-b465f30750ce}" symbol="13" label="39 - 42"/>
      <rule filter="ino2_2020 > 42 AND ino2_2020 &lt;= 44.999" key="{9976186b-5014-4a4f-9cb5-f5e949923909}" symbol="14" label="42 - 45"/>
      <rule filter="ino2_2020 > 45 AND ino2_2020 &lt;= 47.999" key="{85e132d2-a662-4628-9f69-7d705af8f5c9}" symbol="15" label="45 - 48"/>
      <rule filter="ino2_2020 > 48 AND ino2_2020 &lt;= 50.999" key="{a372877d-4935-4317-889f-3df0a1f8f64e}" symbol="16" label="48 - 51"/>
      <rule filter="ino2_2020 > 51 AND ino2_2020 &lt;= 53.999" key="{06ba48f0-7a37-49b9-b745-39401cad2481}" symbol="17" label="51 - 54"/>
      <rule filter="ino2_2020 > 54 AND ino2_2020 &lt;= 56.999" key="{c1fd5c1a-69bc-42a8-8d7c-da96c71d482e}" symbol="18" label="54 - 57"/>
      <rule filter="ino2_2020 > 57 AND ino2_2020 &lt;= 59.999" key="{d8aafc92-d97c-4d02-b6f9-eca9832223e5}" symbol="19" label="> 57"/>
    </rules>
    <symbols>
