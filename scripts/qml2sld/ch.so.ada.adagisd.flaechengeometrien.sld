...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>ch.so.ada.adagisd.flaechengeometrien</se:Name>
    <UserStyle>
      <se:Name>ch.so.ada.adagisd.flaechengeometrien</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
        ...
        <se:Rule>
          <se:Name>Schutzstatus 1 - geschütztes Areal</se:Name>
          <se:Description>
            <se:Title>Schutzstatus 1 - geschütztes Areal</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsEqualTo>
        ...
        <se:Rule>
          <se:Name>Schutzstatus 2 - erhaltenswertes Areal</se:Name>
          <se:Description>
            <se:Title>Schutzstatus 2 - erhaltenswertes Areal</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsEqualTo>
        ...
        <se:Rule>
          <se:Name>Schutzstatus 3 - schützenswertes Areal</se:Name>
          <se:Description>
            <se:Title>Schutzstatus 3 - schützenswertes Areal</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsEqualTo>
        ...
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#989898</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              <se:SvgParameter name="stroke">#000001</se:SvgParameter>
              <se:SvgParameter name="stroke-width">1</se:SvgParameter>
        ...
        <se:Rule>
          <se:Name>Schutzstatus 4 - Areal ohne Einstufung</se:Name>
          <se:Description>
            <se:Title>Schutzstatus 4 - Areal ohne Einstufung</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsEqualTo>
