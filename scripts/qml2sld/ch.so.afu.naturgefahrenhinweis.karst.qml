...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="karst_">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="karst_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="symbol">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="storme_nr">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <aliases>
    ...
    <alias field="karst_" index="3" name=""/>
    <alias field="karst_id" index="4" name=""/>
    <alias field="symbol" index="5" name=""/>
    <alias field="storme_nr" index="6" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="-1736214464">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="karst_"/>
      <column width="-1" hidden="0" type="field" name="karst_id"/>
      <column width="-1" hidden="0" type="field" name="symbol"/>
      <column width="-1" hidden="0" type="field" name="storme_nr"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="karst_" expression=""/>
    <default field="karst_id" expression=""/>
    <default field="symbol" expression=""/>
    <default field="storme_nr" expression=""/>
  </defaults>
