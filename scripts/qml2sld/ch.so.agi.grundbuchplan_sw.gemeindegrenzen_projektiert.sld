...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>ch.so.agi.grundbuchplan_sw.gemeindegrenzen_projektiert</se:Name>
    <UserStyle>
      <se:Name>ch.so.agi.grundbuchplan_sw.gemeindegrenzen_projektiert</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#fa0000</se:SvgParameter>
        ...
        <se:Rule>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              ...
              <se:SvgParameter name="stroke-linejoin">bevel</se:SvgParameter>
              <se:SvgParameter name="stroke-linecap">square</se:SvgParameter>
              <se:SvgParameter name="stroke-dasharray">13 4 4 4</se:SvgParameter>
            </se:Stroke>
          </se:LineSymbolizer>
        </se:Rule>
        <se:Rule>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              ...
              <se:SvgParameter name="stroke-linejoin">bevel</se:SvgParameter>
              <se:SvgParameter name="stroke-linecap">square</se:SvgParameter>
              <se:SvgParameter name="stroke-dasharray">9 2 2 2</se:SvgParameter>
            </se:Stroke>
          </se:LineSymbolizer>
        </se:Rule>
        <se:Rule>
