...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="6000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{eba6959b-5133-45e1-b23c-b6f8fe725674}">
      <rule filter=" &quot;art_txt&quot; !=  'Liegenschaft' " key="{bc52d4c7-3e07-4998-8d47-3b6a672d2c67}" label="proj. selbstständiges und dauerndes Recht">
        <rule scalemaxdenom="300" key="{bb96fe27-2823-43ff-91b8-dd6f01c66375}" symbol="0" label="1:250"/>
        <rule scalemaxdenom="750" key="{b2f925d1-fa82-4200-b85f-7b0c29f15cc4}" symbol="1" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{609f2ad5-6916-4e26-a812-f3a7b31db379}" symbol="2" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{da2ca889-4a16-448c-9f92-364e00689eb4}" symbol="3" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{2adfd1f9-02a3-48d4-b199-d20427fb9da7}" symbol="4" scalemindenom="3000" label="1:5000"/>
      </rule>
      <rule filter=" &quot;art_txt&quot;  =  'Liegenschaft' " key="{4ab74bce-a36c-474f-b5a7-1f3eb1627da1}" label="proj. Liegenschaft">
        <rule scalemaxdenom="300" key="{6695bec3-2bf6-4217-af71-566d0aab8503}" symbol="5" label="1:250"/>
        <rule scalemaxdenom="750" key="{acded23c-84cb-46d2-81c2-7eb012cd6df0}" symbol="6" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{809abe7b-e8d9-4f1f-afd4-46ef2f776d71}" symbol="7" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{1d432a65-5970-4841-a274-2f4cfedff8a3}" symbol="8" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{5d75a43e-f3e3-4eac-a06c-e34a79ecbe91}" symbol="9" scalemindenom="3000" label="1:5000"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{47726cee-0a7f-4d40-a10d-094809c47403}">
      <rule scalemaxdenom="300" key="{cb59b249-7c56-4cd7-a112-1e8431b22a7d}" scalemindenom="1">
        <settings>
          <text-style fontItalic="0" fontFamily="Sans Serif" fontLetterSpacing="0" fontUnderline="1" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="255,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="12.6" fieldName="nummer" namedStyle="Bold" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
      ...
      <rule scalemaxdenom="750" key="{175d837e-5de5-4f43-a9ad-aa200eec8d9b}" scalemindenom="300">
        <settings>
          <text-style fontItalic="0" fontFamily="Sans Serif" fontLetterSpacing="0" fontUnderline="1" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="255,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="12.6" fieldName="nummer" namedStyle="Bold" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
      ...
      <rule scalemaxdenom="1250" key="{79722ff9-9a14-47b1-95db-3ea60640d8b6}" scalemindenom="750">
        <settings>
          <text-style fontItalic="0" fontFamily="Sans Serif" fontLetterSpacing="0" fontUnderline="1" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="255,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="9" fieldName="nummer" namedStyle="Bold" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          <text-format placeDirectionSymbol="0" multilineAlign="4294967295" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
          <text-buffer bufferSize="0.5" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="1" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="128"/>
      ...
      <rule scalemaxdenom="3000" key="{1cd9d8b1-467a-4e5f-9d3d-42a2b39d5a17}" scalemindenom="1250">
        <settings>
          <text-style fontItalic="0" fontFamily="Sans Serif" fontLetterSpacing="0" fontUnderline="1" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="255,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6.3" fieldName="nummer" namedStyle="Bold" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          <text-format placeDirectionSymbol="0" multilineAlign="4294967295" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
      ...
      <rule scalemaxdenom="6000" key="{79c82f94-a23e-4e07-a8d9-8bc4fae394ee}" scalemindenom="3000">
        <settings>
          <text-style fontItalic="0" fontFamily="Sans Serif" fontLetterSpacing="0" fontUnderline="1" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="255,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="3.5" fieldName="nummer" namedStyle="Bold" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          <text-format placeDirectionSymbol="0" multilineAlign="4294967295" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
