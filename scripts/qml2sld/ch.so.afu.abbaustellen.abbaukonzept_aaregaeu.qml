...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="perityp">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="perityp_int">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{7baa7b74-0791-4da7-99bc-a44fdb03a7eb}">
      <rule filter=" &quot;perityp_int&quot;  =  1 " key="{dc43eb67-8812-4502-ad2b-392745baa165}" symbol="0" label="Variante A (genehmigt)"/>
      <rule filter=" &quot;perityp_int&quot;  =  2 " key="{d923be20-966f-4bc0-a7a9-aac66bec7b4b}" symbol="1" label="Variante B"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="perityp" index="2" name=""/>
    <alias field="perityp_int" index="3" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="1888159808">
    <columns>
      <column width="-1" hidden="0" type="field" name="t_id"/>
      <column width="-1" hidden="0" type="field" name="id"/>
      <column width="-1" hidden="0" type="field" name="perityp"/>
      <column width="-1" hidden="0" type="field" name="perityp_int"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="perityp" expression=""/>
    <default field="perityp_int" expression=""/>
  </defaults>
