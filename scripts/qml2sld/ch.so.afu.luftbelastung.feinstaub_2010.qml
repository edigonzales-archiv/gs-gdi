...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{89d1dbc2-870e-43e6-9ce6-47f07fb76813}">
      <rule filter="ipm10_2010 > 0 AND ipm10_2010 &lt;= 1.9999" key="{cd00bed2-bfd8-495e-87b3-baea089117ab}" symbol="0" label="&lt; 2"/>
      <rule filter="ipm10_2010 > 2 AND ipm10_2010 &lt;= 3.9999" key="{7a9c318b-8dd3-4afe-b5aa-d239ceeb266a}" symbol="1" label="2 -4"/>
      <rule filter="ipm10_2010 > 4 AND ipm10_2010 &lt;= 5.9999" key="{69ac94af-c369-449a-9f6a-e6f6a9fb95b5}" symbol="2" label="4 - 6"/>
      <rule filter="ipm10_2010 > 6 AND ipm10_2010 &lt;= 7.9999" key="{8f297eb3-62d9-4765-ac7d-6f16c5830adf}" symbol="3" label="6 - 8"/>
      <rule filter="ipm10_2010 > 8 AND ipm10_2010 &lt;= 9.9999" key="{e95bdd38-51ef-44ad-aa29-56668f4c3f87}" symbol="4" label="8 - 10"/>
      <rule filter="ipm10_2010 > 10 AND ipm10_2010 &lt;= 11.9999" key="{4d727174-ab9a-4568-884a-22ea6ba80690}" symbol="5" label="10 - 12"/>
      <rule filter="ipm10_2010 > 12 AND ipm10_2010 &lt;= 13.9999" key="{2abcf991-528f-4dc1-a1c8-f83a2ce5d019}" symbol="6" label="12 - 14"/>
      <rule filter="ipm10_2010 > 14 AND ipm10_2010 &lt;= 15.9999" key="{896fc2e0-1e9e-4f32-b343-ad2db59215ca}" symbol="7" label="14 - 16"/>
      <rule filter="ipm10_2010 > 16 AND ipm10_2010 &lt;= 17.9999" key="{33c537dc-13e4-464b-ad34-f4f44ee4aa34}" symbol="8" label="16 - 18"/>
      <rule filter="ipm10_2010 > 18 AND ipm10_2010 &lt;= 19.9999" key="{d676c0e5-e241-4dfc-8bde-18fb60f98754}" symbol="9" label="18 - 20"/>
      <rule filter="ipm10_2010 > 20 AND ipm10_2010 &lt;= 21.9999" key="{c8786e06-6419-4142-806e-6cbfab88828e}" symbol="10" label="20 - 22"/>
      <rule filter="ipm10_2010 > 22 AND ipm10_2010 &lt;= 23.9999" key="{cc4e3cc0-7bfe-43dc-96a9-896130543299}" symbol="11" label="22 - 24"/>
      <rule filter="ipm10_2010 > 24 AND ipm10_2010 &lt;= 25.9999" key="{3eb7e898-052f-48d3-9fbf-6852d5868a42}" symbol="12" label="24 - 26"/>
      <rule filter="ipm10_2010 > 26 AND ipm10_2010 &lt;= 27.9999" key="{84d22c77-c33f-4e4b-a6f9-e4e4b9e68e96}" symbol="13" label="26 - 28"/>
      <rule filter="ipm10_2010 > 28 AND ipm10_2010 &lt;= 29.9999" key="{885522c5-59e1-4cee-a3e5-a2b2f3127e38}" symbol="14" label="28 - 30"/>
      <rule filter="ipm10_2010 > 30 AND ipm10_2010 &lt;= 31.9999" key="{c2eb6bf7-5b47-4b02-9357-a5ddc375b229}" symbol="15" label="30 - 32"/>
      <rule filter="ipm10_2010 > 32 AND ipm10_2010 &lt;= 33.9999" key="{21fe23ed-f0cd-467b-8fde-246919e6e626}" symbol="16" label="32 - 34"/>
      <rule filter="ipm10_2010 > 34 AND ipm10_2010 &lt;= 35.9999" key="{292ae3c4-f60e-434f-8004-c9d52009567e}" symbol="17" label="34 - 36"/>
      <rule filter="ipm10_2010 > 36 AND ipm10_2010 &lt;= 37.9999" key="{850bcefd-cae9-430d-83c6-3d02d45d62f6}" symbol="18" label="36 - 38"/>
      <rule filter="ipm10_2010 > 38 AND ipm10_2010 &lt;= 39.9999" key="{07f9966f-3c36-4310-b0e5-d7859d91df59}" symbol="19" label="> 38"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="ino2_2020" index="4" name=""/>
    <alias field="ipm10_2010" index="5" name=""/>
    <alias field="ipm10_2020" index="6" name=""/>
    <alias field="ipm25_2010" index="7" name=""/>
    <alias field="ipm25_2020" index="8" name=""/>
  </aliases>
