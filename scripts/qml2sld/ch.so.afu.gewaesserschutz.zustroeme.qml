...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="im_kanton">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{73f1ac33-5f89-41fb-b501-5f148ef48a4a}">
      <rule filter=" &quot;typ&quot; ='Zo'" key="{37cc8e53-4116-4049-953f-8ff173066206}" symbol="0" label="Zo: Zuströmbereich Inkwilersee"/>
      <rule filter=" &quot;typ&quot; ='Zu' AND  &quot;name&quot;='Neufeld'" key="{9fa0903a-7674-4ebc-8c10-87cf9b044b1c}" symbol="1" label="Zu: Zuströmbereich Grundwasserfassung Neufeld"/>
      <rule filter=" &quot;typ&quot; ='Zu' AND  &quot;name&quot; ='Kappel-Olten'" key="{c6737165-2814-4050-8c6e-fe6c25073032}" symbol="2" label="Zu: Zuströmbereich Grundwasserfassungen Kappel-Olten"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="1">
        <layer pass="0" class="LinePatternFill" locked="0">
          <prop k="angle" v="90"/>
          <prop k="color" v="255,204,102,255"/>
          <prop k="distance" v="2"/>
          <prop k="distance_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="distance_unit" v="MM"/>
          <prop k="line_width" v="1"/>
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@2@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="draw_inside_polygon" v="0"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="204,0,255,255"/>
              <prop k="line_style" v="solid"/>
              <prop k="line_width" v="1"/>
              <prop k="line_width_unit" v="MM"/>
              <prop k="offset" v="0"/>
  ...
  <aliases>
    ...
    <alias field="im_kanton" index="2" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="im_kanton"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="im_kanton" expression=""/>
