<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="1" minimumScale="0" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.19">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{0c53a202-7478-4437-8505-87d4dc0582f7}">
      <rule key="{dc18f479-25ab-4976-9d98-cbf0a5888769}" scalemaxdenom="100000" scalemindenom="1" symbol="0">
        <rule filter="&quot;o_art&quot; = 'V1'" key="{6751b27c-be10-4676-aac1-6a05dfa488c4}" label="Bahnhaltestelle Vorhaben" symbol="1" />
        <rule filter="&quot;o_art&quot; = 'V3'" key="{4c2f13bc-d972-4f73-8680-7e9e48745ee5}" label="Autobahnanschluss" symbol="2" />
        <rule filter="&quot;o_art&quot; = 'V2'" key="{360bf912-5657-4153-beee-381937dc6ba6}" label="Flugplatz/Flugfeld" symbol="3" />
        <rule filter="&quot;o_art&quot; = 'V31'" key="{529cc50b-0869-4557-9679-93c34b1614ec}" label="Autobahnanschluss Vorhaben" symbol="4" />
      </rule>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" type="marker">
        <layer class="SimpleMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
          <prop k="color" v="208,247,107,255" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" type="marker">
        ...
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/3c8aad66e3bbbeaa88d7de40437c2b21.svg" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="0,0,0,255" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="2" type="marker">
        ...
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/e39f1d4fecc8da0cf1fc37badda516bf.svg" />
          <prop k="offset" v="0,1.75" />
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="0,0,0,255" />
          <prop k="outline_width" v="0" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="3" type="marker">
        ...
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="color" v="0,0,0,255" />
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/f71d7f768125828714f489f3a0fa07f7.svg" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="0,0,0,255" />
