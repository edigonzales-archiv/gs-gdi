...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>ch.so.ada.adagisd.objekte_erhaltenswert_flaeche</se:Name>
    <UserStyle>
      <se:Name>ch.so.ada.adagisd.objekte_erhaltenswert_flaeche</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>erhaltenswert</se:Name>
          <se:Description>
            <se:Title>erhaltenswert</se:Title>
          </se:Description>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#4ba403</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              ...
              <se:GraphicFill>
                <se:Graphic>
                  <se:Mark>
                    ...
                    <se:Stroke>
                      <se:SvgParameter name="stroke">#4ba403</se:SvgParameter>
                    </se:Stroke>
                  </se:Mark>
                </se:Graphic>
              </se:GraphicFill>
